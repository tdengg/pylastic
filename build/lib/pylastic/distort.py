...
class Distort(object):
    ...
    def __init__(self, volumeconserving = False, mthd = 'Energy', order = 2):
        ...
        self.__LC = None
        self.__strainType = None
        self.__sgn = None
        self.__Lag_strain_list = None
        self.__Lag_strain_list_i = None
        self.__defMatrix = None
    ...
    def set_defMatrix(self, code, volconserving=False):
        ...
        Ls = np.zeros(6)
        for j in range(6):
            Ls[j] = self.Ls_Dic[self.__code][self.__strainType][j]
    ...
    def get_defMatrix(self):
        if self.__defMatrix == None: self.set_defMatrix()
    ...
    def get_info(self, v=True):
        ...
        if v:
            ...
            print "defMatrix : ",self.__defMatrix
